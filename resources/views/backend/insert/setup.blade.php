            ...
            <form method="post" action="{{url('addSettings')}}" enctype="multipart/form-data">
                ...
                <Request type="hidden" name="tbl" value="{{encrypt('setups')}}">
                    <div c lass="form-group">
                        <Request type="file" accept="image/*" name="image" id="file" onchange="loadFile(event)" style="display: none;">
                            </p>
        ...
        <Request type="hidden" name="tbl" value="{{encrypt('setups')}}">
            <div class="form-group">
                <Request type="file" accept="image/*" name="image" id="file" onchange="loadFile(event)" style="display: none;">
                    ...
                    <p><label for="file" style="cursor: pointer;">Upload Image</label></p>
                    <p><img id="output" width="200" src="{{url('public/setups2')}}/{{$data[0]->image}}" /></p>
            </div>
            <div class="form-group">
                <label>Site Title</label>
